...
function tatDen() {
  document.getElementById("lightBulb").src =
    "./img/BAT_TAT_DEN/pic_bulboff.gif";
...
// các value được nhập vào ô input đều là string hết, muốn chuyển nó về dạng number thì dùm hàm ép kiểu dữ liệu là parseInt(number2)
